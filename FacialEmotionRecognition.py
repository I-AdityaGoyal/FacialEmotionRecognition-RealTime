...
while True:
    ...
    if isinstance(face, np.ndarray):
        ...
        if pred[0][0] > 0.5:        # if it is binary clf and you have used sigmoid activation
            name = "Mayank"         # enter the object-1
        elif pred[0][0]<0.5:
            name = "Aditya"         # enter the object-2
        else:
            name = "None Match"     # if you are using softmax add more elif conditions according to your dataset
